...
\address{Street}{Postal code, Town}    % optional, remove the line if not wanted
...
\cvcomputer{Web}{\small Link to web \normalsize}{LinkedIn}{\small  Link to profile \normalsize}
\cvline{Blog}{\small \url{Link to blog}\normalsize}
